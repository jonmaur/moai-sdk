...
int MOAIAdmobAndroid::_bannerReady ( lua_State* L ) {
    ...
    if ( admob == NULL ) {
		...
		ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find java class %s", "com/ziplinegames/moai/MoaiAdmob" );
    } else {

    	jmethodID bannerLoaded = env->GetStaticMethodID ( admob, "bannerReady", "()Z" );
   		if ( bannerLoaded == NULL ) {

			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "bannerLoaded" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID interstitialLoaded = env->GetStaticMethodID ( admob, "interstitialReady", "()Z" );
   		if ( interstitialLoaded == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "interstitialLoaded" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID interstitialVisible = env->GetStaticMethodID ( admob, "interstitialVisible", "()Z" );
   		if ( interstitialVisible == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "interstitialVisible" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID bannerVisible = env->GetStaticMethodID ( admob, "bannerVisible", "()Z" );
   		if ( bannerVisible == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "bannerVisible" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID loadBanner = env->GetStaticMethodID ( admob, "loadBanner", "()V" );
   		if ( loadBanner == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "loadBanner" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID loadInterstitial = env->GetStaticMethodID ( admob, "loadInterstitial", "()V" );
   		if ( loadInterstitial == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "loadInterstitial" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID showBanner = env->GetStaticMethodID ( admob, "showBanner", "()V" );
   		if ( showBanner == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "showBanner" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID showInterstitial = env->GetStaticMethodID ( admob, "showInterstitial", "()V" );
   		if ( showInterstitial == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "showInterstitial" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID hideBanner = env->GetStaticMethodID ( admob, "hideBanner", "()V" );
   		if ( hideBanner == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "hideBanner" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID destroyAdview = env->GetStaticMethodID ( admob, "destroyAdview", "()V" );
   		if ( destroyAdview == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "destroyAdview" );
		} else {
    ...
    if ( admob == NULL ) {
    	...
    	jmethodID requestTestAds = env->GetStaticMethodID ( admob, "requestTestAds", "()V" );
   		if ( requestTestAds == NULL ) {
			...
			ZLLog::LogF ( ZLLog::CONSOLE, "MOAIAdmobAndroid: Unable to find static java method %s", "requestTestAds" );
		} else {
